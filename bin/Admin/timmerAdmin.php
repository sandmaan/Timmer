...
include_once ("../Functions/usrChekAdmin.php");
?>
<!DOCTYPE html>
...
<div class="w3-bar w3-light-gray w3-card-4">
    ...
    <div class="w3-dropdown-hover">
        ...
        <div class="w3-dropdown-content w3-bar-block w3-card-4">
            ...
            <a href="../Functions/editTimeEntry.php" target="container" class="w3-bar-item w3-button w3-hover-light-blue" >Edit Time Entry</a>
    ...
    <div class="w3-dropdown-hover">
        ...
        <div class="w3-dropdown-content w3-bar-block w3-card-4">
            <a href="createUser.php" target="container" class="w3-bar-item w3-button w3-hover-light-blue">New User</a>
            <a href="listUser.php" target="container" class="w3-bar-item w3-button w3-hover-light-blue" >Edit users</a>
        </div>
    </div>
    <div class="w3-dropdown-hover">
